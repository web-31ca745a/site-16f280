        ...
        <div className="flex flex-col items-center space-y-8 w-full">
            ...
            <AnimatePresence>
                {showVideo && (
                    ...
                    >
                        <div className="relative w-full max-w-4xl bg-lis-white border-2 border-lis-dark/30 shadow-soft-lg p-4 rounded-soft">
                            <button
                            ...
                            <div className="aspect-video bg-brutal-black border-2 border-lis-dark/30 flex items-center justify-center rounded-soft">
                                <p className="text-lis-light font-mono">
                                    Playing video: response-{showVideo}.mp4
                                </p>
